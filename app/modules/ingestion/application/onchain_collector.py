...
def normalize_transfer_event(
    ...
    try:
        ...
        content = {
            ...
            "blockchain": "ethereum",
            # Trade-record fields — allow trade_records.py to capture this event
            "token_in": token,
            "token_out": "USD",
            "amount_in": float(Decimal(amount) / Decimal(10**token_decimals)),
            "amount_out": usd_value,
...
def monitor_large_transfers():
    ...
    try:
        ...
        logger.info("[MONITOR] MONITORING CYCLE COMPLETE")
