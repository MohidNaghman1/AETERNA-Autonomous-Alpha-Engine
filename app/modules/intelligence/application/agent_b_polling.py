...
BATCH_SIZE = int(os.environ.get("AGENT_B_BATCH_SIZE", 50))  # Process 50 events at a time
...
def process_batch():
    ...
    try:
        ...
        needs_profiling = [e for e in unprocessed if needs_agent_b_profiling(e.event_data)]
        ...
        logger.info(f"[AGENT B] ✓ Batch complete: {processed_count}/{len(needs_profiling)} processed")
...
def start_polling():
    ...
    logger.info("[AGENT B POLLING] Polling ProcessedEvent table for unprofile events...")
