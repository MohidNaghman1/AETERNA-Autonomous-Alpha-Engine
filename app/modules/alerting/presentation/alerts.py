...
def _format_agent_b_for_response(
    ...
    formatted = {
        ...
        "inferred_entity_name": agent_b_data.get("inferred_entity_name"),
        "inferred_entity_type": agent_b_data.get("inferred_entity_type"),
        "inferred_entity_reason": agent_b_data.get("inferred_entity_reason"),
